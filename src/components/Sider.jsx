...
const Sider = () => {
    ...
    return (
        <div className={`relative flex flex-col justify-between min-h-screen gap-10  bg-[#F2F3F3] dark:bg-[#111418] ease-in-out duration-200 py-4  ${open ? "md:w-3/12 px-6" : "items-center w-0 lg:-left-0 lg:w-1/12 "} `}>
